...
function filterNewsByCategory(category) {
    ...
    if (category === 'all') {
        ...
        document.querySelectorAll('.news-category-btn').forEach(btn => btn.classList.remove('active'));
        ...
        if (allIndex !== -1) {
            ...
            document.querySelector('.news-category-btn[data-category="all"]')?.classList.remove('active');
        }
        ...
        if (currentNewsCategories.length === 0) {
            currentNewsCategories = ['all'];
            document.querySelector('.news-category-btn[data-category="all"]')?.classList.add('active');
        }
    }
